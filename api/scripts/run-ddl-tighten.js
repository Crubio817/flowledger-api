// Run tightening DDL for Workstream Module v2.1
...
async function main() {
  ...
  try {
    ...
    const ddlPath = path.resolve(__dirname, '20250907_tighten_workstream.sql');
    ...
    console.log('Tightening DDL migration completed successfully.');
    process.exit(0);
  } catch (e) {

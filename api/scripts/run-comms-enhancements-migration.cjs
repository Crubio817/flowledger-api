// Run Comms Enhancements migration
...
async function main() {
  ...
  try {
    ...
    const sqlFile = path.resolve(__dirname, '20250908_comms_enhancements.sql');
    ...
    console.log('Comms Enhancements migration completed successfully');
    process.exit(0);
  } catch (e) {

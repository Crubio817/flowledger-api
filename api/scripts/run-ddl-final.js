// Run final tightenings DDL for Workstream Module v2.1
...
async function main() {
  ...
  try {
    ...
    const ddlPath = path.resolve(__dirname, '20250907_final_tightenings.sql');
    ...
    console.log('Final tightenings DDL migration completed successfully.');
    process.exit(0);
  } catch (e) {
